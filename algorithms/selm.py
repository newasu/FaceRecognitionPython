...
class selm(object):
    ...
    def grid_search_cv_parallel(self, kfold_training_idx, kfold_test_idx, trainingDataX, trainingDataY, trainingDataID, param_grid, exp_path, exp_name, **kwargs):
        ...
        # Init result
        cv_results = pd.DataFrame(columns=['fold', 'distanceFunc', 'kernel_param', 'hiddenNodePerc', 'regC', 'auc', 'auc_pos', 'f1score']) # define column names
