...
def eval_result(data_id, data_trueY, data_score, data_label_classes):
    ...
    tmp_0 = my_label.loc[tmp_0]['label'].values
    tmp_1 = tmp.str[1].astype(int) - 1
    tmp_1 = my_label.loc[tmp_1]['label'].values
...
# filename = 'exp_5_alg_selmEuclidMeanPOS'
# filename = 'exp_5_alg_selmEuclidMultiplyPOS'
...
save_folder = 'exp_5_avg_classes'

for fn_idx in tqdm(range(0, len(filename))):
    save_name = filename[fn_idx] + '_avg_classes'
