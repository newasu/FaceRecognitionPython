...
# Run exp_5_avg_ethnicities.py

save_folder = 'exp_5'
load_folder = 'exp_5_avg_ethnicities'
# filenames = ['exp_5_alg_euclid_avg_ethnicities', 'exp_5_alg_selmEuclidDist_avg_ethnicities', 'exp_5_alg_selmEuclidDistPOS_avg_ethnicities', 'exp_5_alg_selmEuclidSum_avg_ethnicities', 'exp_5_alg_selmEuclidSumPOS_avg_ethnicities', 'exp_5_alg_selmRBFDist_avg_ethnicities', 'exp_5_alg_selmRBFDistPOS_avg_ethnicities']
# filenames = ['exp_5_alg_euclid_avg_ethnicities', 'exp_5_alg_selmEuclidDistPOS_avg_ethnicities', 'exp_5_alg_selmEuclidMeanPOS_avg_ethnicities', 'exp_5_alg_selmEuclidMultiplyPOS_avg_ethnicities', 'exp_5_alg_selmEuclidSumPOS_avg_ethnicities', 'exp_5_alg_selmRBFDistPOS_avg_ethnicities']
filenames = ['exp_5_alg_euclid_avg_ethnicities', 'exp_5_alg_selmEuclidDistPOS_avg_ethnicities', 'exp_5_alg_selmEuclidMeanPOS_avg_ethnicities', 'exp_5_alg_selmEuclidMultiplyPOS_avg_ethnicities', 'exp_5_alg_selmEuclidSumPOS_avg_ethnicities']

# Initial variables
exp_round = ['0', '1', '2', '3', '4']
data_classes = ['asian', 'black', 'caucasian']
