...
# Run exp_5_avg_genders.py

save_folder = 'exp_5'
load_folder = 'exp_5_avg_genders'
# filenames = ['exp_5_alg_euclid_avg_genders', 'exp_5_alg_selmEuclidDistPOS_avg_genders', 'exp_5_alg_selmEuclidMeanPOS_avg_genders', 'exp_5_alg_selmEuclidMultiplyPOS_avg_genders', 'exp_5_alg_selmEuclidSumPOS_avg_genders', 'exp_5_alg_selmRBFDistPOS_avg_genders']
filenames = ['exp_5_alg_euclid_avg_genders', 'exp_5_alg_selmEuclidDistPOS_avg_genders', 'exp_5_alg_selmEuclidMeanPOS_avg_genders', 'exp_5_alg_selmEuclidMultiplyPOS_avg_genders', 'exp_5_alg_selmEuclidSumPOS_avg_genders']

# Initial variables
exp_round = ['0', '1', '2', '3', '4']
data_classes = ['female', 'male']
