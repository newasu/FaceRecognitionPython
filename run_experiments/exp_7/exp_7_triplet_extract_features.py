...
all_classes = ['female-asian', 'female-black', 'female-caucasian', 'male-asian', 'male-black', 'male-caucasian']
...
data_class = (my_data['gender'] + '-' + my_data['ethnicity']).values
# Load model
model = {}
for idx in all_classes:
...
# Write
exacted_data.to_csv((dataset_path + 'Diveface_' + dataset_exacted + '_nonorm_' + exp + '.txt'), header=True, index=False, sep=' ', mode='a')
